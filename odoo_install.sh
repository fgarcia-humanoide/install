...
# Con algunas modificaciones de Humanoide
#-------------------------------------------------------------------------------
...
#sudo git clone --depth 1 --branch $OE_VERSION https://www.github.com/OCA/OCB.git $OE_HOME_EXT/
...
if [ $IS_ENTERPRISE = "True" ]; then
    ...
    sudo su root -c "printf 'addons_path=${OE_HOME}/custom/addons,${OE_HOME_EXT}/addons\n' >> /etc/${OE_CONFIG}.conf"
fi
